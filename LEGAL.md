...
Coast trademarks, Product Identity, official rulebook or adventure text,
artwork, maps, lore, monsters, spells, modules, uploads, generated campaign
...
trademark rules, and any other third-party content licenses.
...
## Public repository content / 公共仓库内容

The public repository intentionally excludes scanned/OCR-converted official
D&D books, published adventures, uploaded source files, parsed module output,
PDF/CHM book archives, local secrets, and API keys.

Some reference data may be bundled for product functionality. Bundled reference
data, if any, is not licensed under Apache-2.0 unless explicitly stated; see
[`NOTICE.md`](./NOTICE.md) and [`LICENSE-OGL.md`](./LICENSE-OGL.md) for the
separate content notices.
...
Some System Reference Document (SRD) material may be present as Open Game
Content or otherwise referenced by the product. See
[`LICENSE-OGL.md`](./LICENSE-OGL.md) for the Open Gaming License text and
